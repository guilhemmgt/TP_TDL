...
public class VariableDeclaration implements Declaration, Instruction {
	...
	public boolean checkType() {
		...
		boolean res = this.type.compatibleWith(valueType) || valueType.compatibleWith(this.type);
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		code.append(this.value.getCode(_factory)); // code value
		code.add(_factory.createStore(this.register, this.offset, this.type.length())); // STORE
